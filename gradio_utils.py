...
def get_video_from_canny_selection(canny_selection):
    if canny_selection == "woman1":
        input_video_path = "extensions/Text2Video-Zero-sd-webui/__assets__/db_files_2fps/woman1.mp4"

    elif canny_selection == "woman2":
        input_video_path = "extensions/Text2Video-Zero-sd-webui/__assets__/db_files_2fps/woman2.mp4"

    elif canny_selection == "man1":
        input_video_path = "extensions/Text2Video-Zero-sd-webui/__assets__/db_files_2fps/man1.mp4"
...
def logo_name_to_path(name):
    logo_paths = {
        'Picsart AI Research': 'extensions/Text2Video-Zero-sd-webui/__assets__/pair_watermark.png',
        'Text2Video-Zero': 'extensions/Text2Video-Zero-sd-webui/__assets__/t2v-z_watermark.png',
        'None': None
    }
