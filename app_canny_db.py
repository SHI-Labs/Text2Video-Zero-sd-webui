...
def create_demo(model: Model):
    ...
    with gr.Blocks() as demo:
        ...
        with gr.Row():
            gallery_db = gr.Gallery(label="Db models", value=[(f'{scripts.basedir()}/extensions/Text2Video-Zero-sd-webui/__assets__/db_files/anime.jpg', "anime"), (f'{scripts.basedir()}/extensions/Text2Video-Zero-sd-webui/__assets__/db_files/arcane.jpg', "Arcane"), (f'{scripts.basedir()}/extensions/Text2Video-Zero-sd-webui/__assets__/db_files/gta.jpg', "GTA-5 (Man)"), (f'{scripts.basedir()}/extensions/Text2Video-Zero-sd-webui/__assets__/db_files/avatar.jpg', "Avatar DB")]).style(grid=[4], height=50)
        with gr.Row():
            gallery_canny = gr.Gallery(label="Motions", value=[(f'{scripts.basedir()}/extensions/Text2Video-Zero-sd-webui/__assets__/db_files/woman1.gif', "woman1"), (f'{scripts.basedir()}/extensions/Text2Video-Zero-sd-webui/__assets__/db_files/woman2.gif', "woman2"), (f'{scripts.basedir()}/extensions/Text2Video-Zero-sd-webui/__assets__/db_files/man1.gif', "man1"), (f'{scripts.basedir()}/extensions/Text2Video-Zero-sd-webui/__assets__/db_files/woman3.gif', "woman3")]).style(grid=[4], height=50)
