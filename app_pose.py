...
def create_demo(model: Model):
    with gr.Blocks() as demo:
        ...
        with gr.Row():
            ...
            with gr.Column():
                gallery_pose_sequence = gr.Gallery(label="Pose Sequence", value=[(os.path.join(scripts.basedir(), 'extensions/Text2Video-Zero-stable-diffusion-webui', '__assets__/poses_skeleton_gifs/dance1.gif'), "Motion 1"), (os.path.join(scripts.basedir(), 'extensions/Text2Video-Zero-stable-diffusion-webui','__assets__/poses_skeleton_gifs/dance2.gif'), "Motion 2"), (os.path.join(scripts.basedir(), 'extensions/Text2Video-Zero-stable-diffusion-webui', '__assets__/poses_skeleton_gifs/dance3.gif'), "Motion 3"), (os.path.join(scripts.basedir(), 'extensions/Text2Video-Zero-stable-diffusion-webui', '__assets__/poses_skeleton_gifs/dance4.gif'), "Motion 4"), (os.path.join(scripts.basedir(), 'extensions/Text2Video-Zero-stable-diffusion-webui', '__assets__/poses_skeleton_gifs/dance5.gif'), "Motion 5")]).style(grid=[2], height="auto")
